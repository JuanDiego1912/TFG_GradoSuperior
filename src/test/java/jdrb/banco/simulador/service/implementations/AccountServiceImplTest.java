...
class AccountServiceImplTest {
    ...
    void getAccountById_valid_returnsAccount() {
        ...
        assertEquals(account, accountService.getAccountById("A2"));
    }
    ...
    void getAccountsByClient_valid_returnsList() {
        List<Account> accounts = Arrays.asList(buildAccount("A1", "C1"), buildAccount("A2", "C1"));
    ...
    private Account buildAccount(String id, String customerId) {
        ...
        account.setAccountBalance(100.0f);
        return account;
    }
}
